...
import co.com.mirecarga.vendedor.notification.NotificationListFragment;
import co.com.mirecarga.vendedor.offline.VendedorOfflineService;
import co.com.mirecarga.vendedor.persistence.Persistence;
...
public class MainActivity extends AppCompatActivity implements
    ...
    /**
     * Manejo de eventos de los menus desplegables.
     */
    ...
    @Inject
    PersistenceMVP.Presenter presenter;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        //Seermebe Creacion de base de datos inicial
...
//    /**
//     * Recuperar el Token del dispositivo.
//     */
...
//                });
//
//        /*//Suscribir el dispositivo en un Topic para FCM
...
//    }
     ...
     */
    private void mostrarPaginaInicial() throws PersistenceException {
    ...
    public final void setTitulo(final String titulo) {
        if (!TextUtils.isEmpty(titulo)) {
            ...
            if (supportActionBar != null) {
                final StringBuilder buffer = new StringBuilder(titulo);
                if (offline) {
    ...
    private void navegar(final Fragment fragment, final boolean remplazar) {
        ...
        transaction.replace(R.id.notification_fragment, new NotificationListFragment());
        if (!remplazar) {
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        final RespuestaInicio resp = getModelo();
        final MenuItem noti = menu.findItem(R.id.action_right_drawer);
        final MenuItem item = menu.findItem(R.id.action_settings);
        noti.setVisible(resp.isAutenticado());
        ...
        View actionView = noti.getActionView();
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        ...
        // automatically handle clkicks on the Home/Up button, so long
    ...
    private void setupBadge() {
        ...
        if (textCartItemCount != null) {
            if (mCartItemCount == 0) {
                ...
                textCartItemCount.setText(mCartItemCount > 9 ? "+9" : String.valueOf(mCartItemCount));
