 ...
 */
@Singleton
public class MapaClienteServiceBean implements MapaClienteService {
    /**
     * El tag para el log.
     */
    private static final String TAG = "MapaClienteServiceBean";
     ...
     */
    @Inject
    public MapaClienteServiceBean(final Context context, final ConfigService<ConfigCliente> configService) {
