...
public class Persistence extends SQLiteOpenHelper implements BaseColumns {
    ...
    private static final String SQL_CREATE_ENTRIES =
            ...
            CREATE_TABLE + TABLE_CONNECTIONS + " (" +
                    _ID + INT_TYPE + CONSTRAINT_PK + COMMA_SEP +
    ...
    private ContentValues getValues(MQTTConnection connection){
